            ...
            <div className="glass-panel relative overflow-hidden p-6">
              ...
              <div className="relative flex items-center gap-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <form onSubmit={handleSearch} className="mt-4 flex items-center gap-2 rounded-full border border-border bg-background/80 px-4 py-2 shadow-sm">
                    ...
                    />
                    <button type="submit" className="shrink-0 rounded-full bg-primary px-4 py-1.5 text-xs font-semibold text-primary-foreground">
                      Search
                    </button>
                    <button type="button" className="shrink-0 rounded-full border border-border bg-background px-2.5 py-1 text-muted-foreground">
